...
public class OrderCancelledDomainEventHandlerTests {
    ...
    @InjectMocks
    OrderCancelledDomainEventHandler handler;
    ...
    void setUp() {
        ...
        this.domainEvent = new OrderCancelledDomainEvent(order);
    }
    ...
    void successfullySendsIntegrationEvent() {
        ...
        // assert
        verify(orderingIntegrationEventService).addAndSaveEvent(any(OrderStatusChangedToCancelledIntegrationEvent.class));
    }
