...
public class OrderStatusChangedToAwaitingValidationDomainEventHandlerTests {
    ...
    @InjectMocks
    OrderStatusChangedToAwaitingValidationDomainEventHandler handler;
    ...
    @BeforeEach
    void setUp() {
        this.domainEvent = new OrderStatusChangedToAwaitingValidationDomainEvent(orderId, List.of());
    }
    ...
    void successfullySendsIntegrationEvent() {
        ...
        // assert
        verify(orderingIntegrationEventService).addAndSaveEvent(any(OrderStatusChangedToAwaitingValidationIntegrationEvent.class));
    }
